...
grid
title(handles.Pre,'Presión Atmósfera Isoentrópica (Marte)','color','w')
...
grid
title(handles.Temp,'Temperatura Atmósfera Isoentrópica (Marte)','color','w')
...
grid
title(handles.Dens,'Densidad Atmósfera Isoentrópica (Marte)','color','w')
