...
grid
title(handles.Incom,'Presión Atmósfera Incompresible(Marte)','color','w')
...
grid
title(handles.Isot,'Presión Atmósfera Isotérmica (Marte)','color','w')
...
grid
title(handles.Isoe,'Presión Atmósfera Isoentrópica (Marte)','color','w')
